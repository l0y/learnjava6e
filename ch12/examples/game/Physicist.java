...
public class Physicist implements GamePiece, ActionListener {
  ...
  // Boundary helpers
  private final int psize = Field.PHYSICIST_SIZE_IN_PIXELS;
  private final int physicistHeight = (int) (1.5 * psize);
  ...
  public void setPosition(int x, int y) {
    ...
    this.y = y - offset;
    boundingBox =
      new Rectangle(x, y, Field.PHYSICIST_SIZE_IN_PIXELS, physicistHeight);
  }
  ...
  public void draw(Graphics g) {
    ...
    g.setColor(color);
    g.fillArc(x, y, psize, psize, 0, 180);
    g.fillRect(x, centerY, psize, psize);
  ...
  public boolean isTouching(GamePiece otherPiece) {
    ...
    return GameUtilities.doBoxesIntersect(
      boundingBox,
      otherPiece.getBoundingBox()
    );
  }
